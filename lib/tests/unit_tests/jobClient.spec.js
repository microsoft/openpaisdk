...
const testJobFrameworkInfo_1 = require("../common/test_data/testJobFrameworkInfo");
...
describe('Get job framework information', () => {
    const response = testJobFrameworkInfo_1.testJobFrameworkInfo;
    const userName = 'core';
    const jobName = 'tensorflow_serving_mnist_2019_6585ba19';
